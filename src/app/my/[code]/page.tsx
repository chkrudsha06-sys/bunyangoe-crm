        ...
        <div style={{padding:"24px 20px"}}>
          <div style={{background:"#111",borderRadius:16,padding:"20px",marginBottom:20,display:"flex",gap:16}}>
            ...
            <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end"}}>
              <img src="/bunyanghoe-logo.png" alt="" style={{width:"100%",height:150,objectFit:"contain",marginBottom:6}} onError={e=>{(e.currentTarget as HTMLImageElement).style.display="none"}}/>
