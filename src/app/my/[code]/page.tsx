      ...
      <div className="mob-view">
        ...
        <div style={{padding:"24px 20px"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:16}}>
            <div style={{background:"#eff6ff",borderRadius:14,padding:"18px 16px",border:"1px solid #bfdbfe"}}><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}><div style={{display:"flex",alignItems:"center",gap:5}}><NumBadge n={1} color="#3b82f6"/><span style={{fontSize:11,fontWeight:600,color:"#3b82f6"}}>하이타겟 마일리지</span></div><HelpIcon type="mileage" size={15}/></div><p style={{fontSize:18,fontWeight:800,color:"#1e293b",whiteSpace:"nowrap"}}>{fw(stats.remainMileage)}<span style={{fontSize:12,color:"#94a3b8",marginLeft:2}}>P</span></p></div>
            <div style={{background:"#fff7ed",borderRadius:14,padding:"18px 16px",border:"1px solid #fed7aa"}}><div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}><div style={{display:"flex",alignItems:"center",gap:5}}><NumBadge n={2} color="#ea580c"/><span style={{fontSize:11,fontWeight:600,color:"#ea580c"}}>리워드</span></div><HelpIcon type="reward" size={15}/></div><p style={{fontSize:18,fontWeight:800,color:"#1e293b",whiteSpace:"nowrap"}}>{fw(stats.totalReward)}<span style={{fontSize:12,color:"#94a3b8",marginLeft:2}}>원</span></p></div>
          </div>
