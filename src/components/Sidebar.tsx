...
const EXEC_MENUS = [
  ...
  { href: "/customer-journey", label: "고객여정 (사용금지)", emoji: "🗺️" },
  { href: "/tasks", label: "업무전달", emoji: "📬" },
  { href: "/contacts", label: "고객 DB (사용금지)", emoji: "👥" },
...
const OPS_MENUS = [
  ...
  { href: "/member-timeline", label: "회원 타임라인", emoji: "📅" },
...
const ADMIN_EXTRA = [
  ...
  { href: "/settlement-report", label: "결산보고서", emoji: "📊" },
